...
describe('YAMLTemplateFieldWriter', () => {
  test('read a JSON field, and writes it as YAML', () => {
    ...
    expect(stringified.length).toBe(821);
    // console.log(stringified);
    // const objectified = yamlWriter.getYamlAsJsonNode(jsonFieldReaderResult.field);
    // TestUtil.p(objectified);
    /*
