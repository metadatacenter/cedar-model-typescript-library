...
describe('CedarJsonPath', () => {
  ...
  test('join combines two paths', () => {
    const path1 = new CedarJsonPath('level1');
    const path2 = new CedarJsonPath('level2', 3);
