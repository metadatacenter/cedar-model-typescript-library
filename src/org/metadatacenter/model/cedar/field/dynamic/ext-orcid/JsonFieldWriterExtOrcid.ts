...
export class JsonFieldWriterExtOrcid extends JsonTemplateFieldWriterInternal {
  constructor(behavior: JsonWriterBehavior, writers: CedarJsonWriters) {
    super(behavior, writers);
  }

  override expandValueConstraintsNode(vcNode: JsonNode, field: ExtOrcidField, childInfo: ChildDeploymentInfo): void {
  ...
  override expandRequiredNode(_requiredObject: JsonNode): void {
    // TODO: Should the @id be required in case of an ext-orcid?
  }
}
