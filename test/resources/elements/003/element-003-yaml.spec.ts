...
describe('YAMLTemplateElementWriter - element-003', () => {
  test('read a JSON element, and writes it as YAML', () => {
    const artifactSource = TestUtil.readTestResourceAsString('elements/003', 'element-003.json');
...
id: https://repo.metadatacenter.org/template-elements/34c95bb0-d51a-416e-a6a8-08fa10f7c6eb
name: #003 Element with another element
status: bibo:draft
version: 0.0.1
modelVersion: 1.6.0
createdOn: 2024-03-12T12:23:16-07:00
createdBy: https://metadatacenter.org/users/c7dcc3ca-55fe-4ca8-b448-ab110bfe4c95
lastUpdatedOn: 2024-03-12T12:23:53-07:00
...
children:
  - key: #002 Element with three fields
    ...
    version: 0.0.1
    modelVersion: 1.6.0
    createdOn: 2024-03-12T12:23:53-07:00
    createdBy: https://metadatacenter.org/users/c7dcc3ca-55fe-4ca8-b448-ab110bfe4c95
    lastUpdatedOn: 2024-03-12T12:23:53-07:00
    modifiedBy: https://metadatacenter.org/users/c7dcc3ca-55fe-4ca8-b448-ab110bfe4c95
    children:
