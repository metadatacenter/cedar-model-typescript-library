...
function generateProbes(): string[] {
  ...
  const resolverTokens = [
    'y', 'Y', 'n', 'N', 'yes', 'Yes', 'YES', 'yEs', 'no', 'No', 'NO', 'on', 'On', 'ON', 'off', 'Off', 'OFF',
    'true', 'True', 'TRUE', 'false', 'False', 'null', 'Null', 'NULL', '~', '', ' ', '  ',
    '0', '-0', '+0', '42', '-42', '007', '0755', '0o755', '0x1F', '-0x1F', '0b1010', '1_000',
    '3.14', '-3.14', '.5', '5.', '1e5', '1E5', '1e-5', '.inf', '-.inf', '.NaN', '.nan', 'NaN',
    '1:30', '1:30:30', '12:30:00', '2024-09-06', '2024-09-06T10:03:57-07:00',
    '=', '-', '?', ':', '---', '...', '<<',
  ];
  ...
  const realistic = [
    'this is my template', 'Study Name', 'https://repo.metadatacenter.org/templates/7b8977e',
...
describe('what the writer does with a spelling a reader would claim', () => {
  test.each([
    'yes', 'No', 'ON', 'off', 'true', '0x1F', '-0x1F', '0b1010', '0755', '1_000', '1e5', '-1e5', '.inf', '~', '42',
    '3.14', '12:30:00.5',
